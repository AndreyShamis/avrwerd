...
; 0000 0028 // Func7=Out Func6=Out Func5=In Func4=In Func3=In Func2=Out Func1=In Func0=Out
; 0000 0029 // State7=0 State6=0 State5=T State4=T State3=T State2=0 State1=T State0=0
...
; 0000 0031 DDRD=0x00;
	OUT  0x11,R30
; 0000 0032 
; 0000 0033 // Port E initialization
; 0000 0034 // Func2=In Func1=In Func0=In
; 0000 0035 // State2=T State1=T State0=T
; 0000 0036 PORTE=0x00;
	OUT  0x7,R30
; 0000 0037 DDRE=0x00;
	OUT  0x6,R30
; 0000 0038 
