...
/* Тактовая частота чипа AVR в килогерцах. Допустимые величины 12000, 15000, 16000, 16500
    и 20000. Версия кода 16.5 MHz не требует кристалла, она допускает уход частоты 
    +/- 1% от номинальной. Все другие частоты требуют точности 2000 ppm, и в этом случае
    обязательно нужен кристалл!
   Если не указано, то по умолчанию: 12 MHz
 */
 ...
 */
#define USB_CFG_VENDOR_NAME     '-','L', 'O', 'L', 'N', 'I', 'K', '-'
 ...
 */
#define USB_CFG_DEVICE_NAME     'A','T','m','e','g','a','8','5','1','5'
 ...
 */
#define USB_CFG_DEVICE_CLASS        0//xff    /* Задайте 0, если отложено для интерфейса */
