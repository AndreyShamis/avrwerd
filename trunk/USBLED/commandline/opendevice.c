/*
ќсновное описание:
‘ункции из этого модул€ могут использоватьс€ дл€ нахождени€ и открыти€ устройства, основыва€сь на 
...
/* ѕубличный интерфейс (public interface) дл€ совпадени€ в стиле шелла (shell): возврат 0 если нет совпадени€, 1 если совпадение */
